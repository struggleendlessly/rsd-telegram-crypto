...
namespace ML.WorkerServiceAi
{
    public partial class MLModel_learn22
    {
        ...
        public const string RetrainCommandString = @"SELECT [isGood], CAST([contractCode] as NVARCHAR(MAX)) FROM [dbo].[learn22]";
        /// <summary>
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName: @"contractCode", outputColumnName: @"contractCode")      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{ @"contractCode" }))      
