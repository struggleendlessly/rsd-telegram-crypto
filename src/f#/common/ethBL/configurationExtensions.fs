...
let configureServices (services: IServiceCollection) (configuration: IConfiguration) =
    ...
    services.AddScoped<scoped_swapsTokensToNhours>() |> ignore
    ...
    services.AddScoped<IDictionary<string, IScopedProcessingService>>(
        fun sp -> 
            ...
            dict.Add(scoped_swapsTokensToNhours_Name, sp.GetRequiredService<scoped_swapsTokensToNhours>() :> IScopedProcessingService) 
